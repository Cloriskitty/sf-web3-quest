...
export const companies: Company[] = [
  {
    ...
    shortDescription:
      "America's largest publicly traded crypto exchange, serving 100M+ verified users worldwide.",
    whyItMatters:
      "Coinbase's 2021 Nasdaq IPO was crypto's mainstream debut. Its Mission Rock HQ signals the industry's permanent roots in SF.",
    category: "Exchange",
    ...
    mapSprite: "boss",
    sourceUrl:
      "https://www.costar.com/article/1157093459/coinbase-signs-major-san-francisco-office-deal",
  ...
  },
  {
    ...
    shortDescription:
      "One of the oldest and most trusted crypto exchanges, built on a never-been-hacked track record.",
    whyItMatters:
      "A pioneer since 2011, Kraken offers spot, futures, and staking — and is one of the few major exchanges never compromised by hackers.",
    category: "Exchange",
    locationLabel: "100 Pine St Suite 1250, San Francisco",
    coordinates: [-122.39760, 37.79399],
    founded: 2011,
  ...
  },
  {
    ...
    shortDescription:
      "Blockchain payments network enabling instant, low-cost cross-border settlements via XRP.",
    whyItMatters:
      "Ripple's XRP Ledger and RLUSD stablecoin are rewriting how banks move money across borders at a fraction of traditional costs.",
    category: "Payments",
    locationLabel: "600 Battery St, San Francisco",
    coordinates: [-122.40170, 37.79901],
    founded: 2012,
    sourceUrl:
      "https://coinpaper.com/3362/ripple-headquarters-location-pioneering-the-future-of-finance",
  ...
  },
  {
    ...
    shortDescription:
      "The only federally chartered crypto bank in the US, offering institutional custody and staking.",
    whyItMatters:
      "Anchorage holds an OCC national trust bank charter — the first in crypto history — giving institutions a fully regulated on-ramp to digital assets.",
    category: "Custody",
    locationLabel: "221 Pine St, San Francisco",
    coordinates: [-122.39981, 37.79350],
    founded: 2017,
  ...
  },
  {
    ...
    shortDescription:
      "The developer platform powering the world's top blockchain apps with APIs, nodes, and tooling.",
    whyItMatters:
      "Alchemy is the AWS of Web3 — the invisible infrastructure behind apps serving hundreds of millions of users on Ethereum, Polygon, and beyond.",
  ...
  },
  {
    ...
    shortDescription:
      "Global crypto exchange and Web3 wallet platform serving 50M+ users across 100+ countries.",
    whyItMatters:
      "OKX is building the super-app for Web3 — combining spot, derivatives, DeFi, and NFTs. The SF office anchors its growing US presence.",
    category: "Exchange",
  ...
  },
  {
    ...
    website: "https://www.okx.com",
    shortDescription:
      "OKX's US regional headquarters, established in 2025 as the exchange expands into the American market.",
    whyItMatters:
      "OKX chose San Jose as its American beachhead — a signal of crypto's deepening roots in Silicon Valley's financial and tech ecosystem.",
    category: "Exchange",
  ...
  },
  {
    ...
    shortDescription:
      "The premier platform for compliant token launches and early-stage crypto investing.",
    whyItMatters:
      "CoinList launched Solana, Filecoin, Algorand, and Celo — the public debut stage for the most impactful Web3 protocols ever built.",
    category: "Exchange",
  ...
  },
  {
    ...
    shortDescription:
      "Open-source R&D lab behind IPFS and Filecoin, building foundational internet infrastructure.",
    whyItMatters:
      "Protocol Labs created IPFS and Filecoin — the decentralized storage layer for Web3 powering NFTs, DAOs, and dApps at scale.",
    category: "Infrastructure",
  ...
  },
  {
    ...
    shortDescription:
      "Developer of the Chainlink oracle network, connecting smart contracts to real-world data.",
    whyItMatters:
      "Chainlink oracles secure over $15T in smart contract value. Without reliable data feeds, most DeFi protocols simply could not function.",
    category: "Infrastructure",
    locationLabel: "50 California St Suite 1500, San Francisco",
    coordinates: [-122.39890, 37.79348],
    founded: 2017,
  ...
  },
  {
    ...
    shortDescription:
      "Core engineering team behind the Solana blockchain — the fastest L1 with sub-second finality.",
    whyItMatters:
      "Solana processes 65,000+ TPS and hosts everything from memecoins to institutional payments. Born in SF, now a top-3 global blockchain.",
    category: "Infrastructure",
  ...
  },
  {
    ...
    shortDescription:
      "Institutional-grade digital asset custody, trading, and prime brokerage platform.",
    whyItMatters:
      "BitGo secures more on-chain assets than any other qualified custodian — the backbone of institutional crypto settlement globally.",
    category: "Custody",
    locationLabel: "2443 Ash St, Palo Alto",
    coordinates: [-122.14700, 37.43200],
    founded: 2013,
  ...
  },
  {
    ...
    shortDescription:
      "Builder of the Aptos L1 blockchain, founded by ex-Meta/Diem engineers focused on safety and speed.",
    whyItMatters:
      "Aptos achieves 160,000 TPS in tests via its Block-STM parallel execution engine — born from Silicon Valley's deepest crypto engineering talent.",
    category: "Infrastructure",
    locationLabel: "745 Emerson St, Palo Alto",
    coordinates: [-122.16560, 37.44830],
    founded: 2021,
  ...
  },
  {
    ...
    shortDescription:
      "Creator of the Sui blockchain, designed for high-throughput consumer Web3 apps and gaming.",
    whyItMatters:
      "Sui's object-centric model enables sub-second finality and seamless UX — positioning it as the blockchain of choice for consumer apps.",
    category: "Infrastructure",
    locationLabel: "379 University Ave, Palo Alto",
    coordinates: [-122.16110, 37.44720],
    founded: 2021,
  ...
  },
  {
    ...
    shortDescription:
      "Andreessen Horowitz's dedicated crypto fund — the world's largest Web3 VC with $7.6B+ deployed.",
    whyItMatters:
      "a16z backed Coinbase, Uniswap, OpenSea, and hundreds more. No single firm has shaped the Web3 ecosystem's trajectory more than a16z.",
    category: "Investor",
    locationLabel: "2865 Sand Hill Rd Suite 101, Menlo Park",
    coordinates: [-122.19936, 37.41520],
    founded: 2009,
    mapSprite: "boss",
  ...
  },
  {
    ...
    shortDescription:
      "Commission-free investing app and one of the largest retail crypto gateways in the US.",
    whyItMatters:
      "Robinhood democratized investing for a generation. With 24/7 crypto trading and self-custody wallets, it's now a major Web3 on-ramp.",
    category: "Exchange",
  ...
  },
  {
    ...
    shortDescription:
      "Blockchain gaming platform enabling developers to integrate NFT economies with ease.",
    whyItMatters:
      "Forte builds the rails for Web3 gaming — letting studios launch in-game economies without wrestling with smart contract complexity.",
    category: "Infrastructure",
